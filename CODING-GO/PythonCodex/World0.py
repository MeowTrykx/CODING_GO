...
while typing:
    ...
    for e in pygame.event.get():  # <--- This defines 'e'
...
def death_sequence(player_name):
    ...
    # --- Death text ---
    screen.fill(BLACK)
    draw_centered_text(screen, "You Dide.", font, WHITE, -20)
    ...
    while True:
        ...
        draw_centered_text(screen, "Reborn", ui_font, BLACK, 65)
        draw_centered_text(screen, "Quit", ui_font, BLACK, 65)
...
while running:
    ...
    if hp <= 0:
        ...
        if choice == "reborn":
            ...
            continue  # restart the loop (reborn)
        elif choice == "quit":
            pygame.quit()
