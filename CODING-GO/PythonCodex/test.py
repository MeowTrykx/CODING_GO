...
#from SaveFile import load_save, update_save
...
pygame.display.set_caption("Prototype 1.0")
...
def battle_scene(player_name, player_sprite, player_pos, player_hp, max_hp):
    # load enemy and GUI
    dummy = pygame.image.load("PythonCodex/Enemies/DummyOnGrr.png").convert_alpha()
    ...
    while running:
        ...
        #background (darkened)
        try:
            bg = pygame.image.load("PythonCodex/BGandPLAT/TutorialBackground.png").convert()
...
def tutorial_scene(player_name):
    ...
    platform = pygame.image.load("PythonCodex/BGandPLAT/TutorialPlatform.png").convert_alpha()
    mc_idle = pygame.image.load("PythonCodex/Player/IdleMC.png").convert_alpha()
    mc_walk1 = pygame.image.load("PythonCodex/Player/Walk1.png").convert_alpha()
    mc_walk2 = pygame.image.load("PythonCodex/Player/Walk2.png").convert_alpha()
    angry1 = pygame.image.load("PythonCodex/Player/AngryTalk.png").convert_alpha()
    angry2 = pygame.image.load("PythonCodex/Player/AngryTalk2.png").convert_alpha()
    contemplating_image = pygame.image.load("PythonCodex/Player/Contemplating.png").convert_alpha()
    ...
    dummy_on_grr = pygame.image.load("PythonCodex/Enemies/DummyOnGrr.png").convert_alpha()
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN and event.key == pygame.K_z:
                if tutorial_scene.script_step == 1:
                    ...
                    dialogue_text, current_portrait, speaker = ("WAIT- BATTLE?!", angry2, "Player")
                elif tutorial_scene.script_step == 4:
                    tutorial_scene.script_step = 5
                    dialogue_text, current_portrait, speaker = ("Yes, Battle.", mewo2, "MeowTrykx")
                    ...
                    # --- AFTER BATTLE DIALOGUE SEQUENCE ---
                    current_hp = player_hp_after
                    grumpy = pygame.image.load("PythonCodex/Player/Grumpy.png").convert_alpha()
                    grumpy = pygame.transform.smoothscale(grumpy, (100, 100))

                    # --- Step 6: After battle result ---
                    tutorial_scene.script_step = 6
                    dialogue_text, current_portrait, speaker = ("Gosh, you're terrible at this...", mewo2, "MeowTrykx")

                elif tutorial_scene.script_step == 6:
                    # Player reacts with grumpy face
                    tutorial_scene.script_step = 7
                    dialogue_text, current_portrait, speaker = ("...", grumpy, "Player")

                elif tutorial_scene.script_step == 7:
                    # End of tutorial for now — unlock movement again
